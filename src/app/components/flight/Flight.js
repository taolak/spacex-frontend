    ...
    render() {
        const flightItems = this.props.flights.map(flight => (
            <div className='row' key={flight.flight_number}>
                <div><img src={flight.links.mission_patch_small} alt='refresh' /></div>
                    ...
                    <header className='flight-header'>
                        <ul className='top'>
                            ...
                            <li>
                                ...
                                <label htmlFor='with-reddit-checkbox'>WITH REDDIT </label>
                            </li>
                        </ul>
